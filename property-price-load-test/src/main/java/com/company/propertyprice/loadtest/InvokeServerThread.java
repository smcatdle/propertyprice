...
public class InvokeServerThread extends Thread {
	
	public static final String proxyUrl = "http://sales-propertyprod.rhcloud.com/property-price-server/PropertyServlet?service=getPropertiesWithinViewport&topLeftX=53.2934580000&topLeftY=-6.2288832000&bottomRightX=53.29704582000&bottomRightY=-6.222";
	public static final long TOTAL_ITERATIONS = 100;	
	
	private final Logger logger = Logger.getLogger(InvokeServerThread.class.getName());
	private Result result = null;
	
	public InvokeServerThread(Result result) {
		this.result = result;
	}
