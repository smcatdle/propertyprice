...
public abstract class ExpandableListItemAdapter<T> extends ArrayAdapter<T> {
	 ...
	 */
	protected ExpandableListItemAdapter(Context context, int layoutResId, int titleParentResId, int contentParentResId/*, int buttonResId*/) {
		this(context, layoutResId, titleParentResId, contentParentResId/*, buttonResId*/, null);
	}
	 ...
	 */
	protected ExpandableListItemAdapter(Context context, int layoutResId, int titleParentResId, int contentParentResId/*, int buttonResId*/, List<T> items) {
		super(items);
		mContext = context;
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (titleView != viewHolder.titleView) {
			...
			if (mActionViewResId == 0) {
				...
				view.findViewById(mViewLayoutResId).setOnClickListener(new TitleViewOnClickListener(viewHolder.contentParent));
			}
		}
